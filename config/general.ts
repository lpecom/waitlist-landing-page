const config = {
    ...
    title: "Waitlist Page | Spike",
    description: "Entre para a nova fase",
    subscribeForm: "",

    socials: {
        twitter: "https://instagram.com/lp.ecom",
    },

    contents: {
        title: "Conheça a Spike, pioneira na nova fase do Digital",
        markOfTitle: "Spike", // its for marking the title. The text must contain on title. If not, it will be ignored.
        description: `Cadastre seu e-mail e receba em primeira mão a demonstração da Spike, não vai ficar de fora né?`,
